...
public class AerlTest1 {
    ...
    public void verifyAerl1(){
        ...
        driver.findElement (By.xpath("//*[@id='test_email-3']")).sendKeys("maryia.shynkarenka@aerlingus.com");
        driver.findElement (By.xpath("//*[@id='test_confirmemail-6']")).sendKeys("maryia.shynkarenka@aerlingus.com");
